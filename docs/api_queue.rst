...
-  ``numberOfTopRiskedTenders`` - кількість процедур, що маркуються надризиковими через великий параметр матеріальності їх  замовника. *Надризиковими* процедурами ми будемо вважати ті, що мають бути перевірені у першу чергу.
